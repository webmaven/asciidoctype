...
image:https://img.shields.io/badge/asciimath2mathml-%3E%3D0.3.0b1-teal[asciimath2mathml 0.3.0b1+]
...
|*Native MathML*
|Converts LaTeX math (latexmath) and AsciiMath (asciimath / stem) to native MathML markup at render time via latex2mathml and asciimath2mathml. No downstream JavaScript dependencies like MathJax or KaTeX needed.
|===
