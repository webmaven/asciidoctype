...
image:https://img.shields.io/badge/python-%3E%3D3.9-green[Python 3.9+]
...
* Contributing: link:CONTRIBUTING.adoc[CONTRIBUTING.adoc]
* Agent guidance: link:AGENTS.adoc[AGENTS.adoc]
